...
OFFICIAL_MODEL_NAMES = [
    ...
    "google-t5/t5-large",
    "ai-forever/mGPT",
    "/apdcephfs_qy3/share_301812049/shared/model/meta-llama/Llama-3.1-8B-Instruct",
    "/apdcephfs_qy3/share_301812049/ruerwang/hugging_cache/gemma-2-9b",
    # "/mnt/share/qy/ruerwang/model/Llama-3.1-8B-Instruct"
]
...
def convert_hf_model_config(model_name: str, **kwargs):
    ...
    if official_model_name.startswith(
        ...
        "llama-3-8b" in official_model_name
        or "Meta-Llama-3-8B" in official_model_name
        or "llama-3.1-8b" in official_model_name
        or "Llama-3.1-8B" in official_model_name
        ...
        official_model_name.startswith("google/gemma-2-9b")
        or "gemma-2-9b" in official_model_name.lower()
    ):
